...
export type PublicPromotion = { code: string; label: string; conditions: string; restaurantId: string | null; minimum: number; kind: 'percent' | 'amount' | 'delivery'; value: number; endsAt: string };
